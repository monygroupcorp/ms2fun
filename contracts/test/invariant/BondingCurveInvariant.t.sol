...
contract BondingCurveInvariantTest is StdInvariant, Test {
    ...
    function setUp() public {
        ...
        // field by field, not merely that something got stored ([[helm-vacuous-gates]]).
        _assertLadderSealed();
    ...
    ///          work ships green and worthless ([[helm-vacuous-gates]]). A run that never landed a tier
