  ...
  postCreate: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Opens',
        kind: 'datetime',
        help: 'Leave blank to open the moment the edition is created',
        default: 0,
      },
      {
        key: 'closeTime',
        label: 'Closes',
        kind: 'datetime',
        help: 'Leave blank to run open-ended; otherwise it must fall after the open time',
        default: 0,
      },
      {
        key: 'maxPerWallet',
...
const erc721: ProjectTypeSchema = {
  ...
  coreFields: [
    ...
    },
    {
      ...
      label: 'Base duration',
      kind: 'duration',
      help: 'How long each auction runs before the anti-snipe buffer can extend it',
      validation: { required: true, min: 1 },
    },
    {
      key: 'timeBuffer',
      ...
      kind: 'duration',
      help: 'A bid this close to the end pushes the end out by the same span',
      validation: { required: true, min: 1 },
    },
    {
      key: 'bidIncrement',
