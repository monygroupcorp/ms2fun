...
import { gatewayUrl, IPFS_GATEWAYS, type IpfsGateway } from './gateways'

// Re-exported so nothing that already imports these from './uri' has to move. `gateways.ts` is the
// dependency-free half, shared with the art service, which cannot import this file.
export { gatewayUrl, IPFS_GATEWAYS, isSubdomainSafeCid } from './gateways'
export type { GatewayForm, IpfsGateway } from './gateways'
