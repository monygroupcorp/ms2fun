 ...
 * asserted over an endowment collection, and "19% of every resale" puts the tithe on a resale, where
 * it has never been levied — the EIP-2981 royalty the instances now carry is creator-set and paid to
 * the CREATOR, and routes nothing to a vault. "On every mint" is wrong on every family besides, because the bind lands
