...
export const erc404BondingInstanceAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'mirror', internalType: 'address', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      { name: '', internalType: 'uint256', type: 'uint256' },
      { name: '', internalType: 'enum GatingScope', type: 'uint8' },
    ],
    name: 'initializeFreeMint',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  { type: 'error', inputs: [], name: 'InitStakingFailed' },
  { type: 'error', inputs: [], name: 'InitTierBandsFailed' },
  ...
  { type: 'error', inputs: [], name: 'SetAgentDelegationFailed' },
  { type: 'error', inputs: [], name: 'SetAgentDelegationFromFactoryFailed' },
    ...
    inputs: [
      ...
      },
      {
        ...
        components: [
          ...
          {
            name: 'tiers',
            internalType: 'struct ERC404Factory.TierSpec[]',
            type: 'tuple[]',
            components: [
              { name: 'weight', internalType: 'uint32', type: 'uint32' },
...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link alignmentEndowmentVaultAbi}__ and `functionName` set to `"alignmentRegistry"`
 */
export const useReadAlignmentEndowmentVaultAlignmentRegistry =
  /*#__PURE__*/ createUseReadContract({
    abi: alignmentEndowmentVaultAbi,
