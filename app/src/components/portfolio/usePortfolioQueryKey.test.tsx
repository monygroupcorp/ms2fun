/**
 * usePortfolio — query key regression (noesis-337 / noesis-368).
 *
 ...
 *
 * The fix landed in `portfolioQueryKey` (see `usePortfolio.ts` / `usePortfolio.test.ts`); this
 * file is the wiring proof that the hook's call site actually uses it.
 */
