      ...
      <aside className={styles.heroRight}>
        <div className="noesis-ledger">
          ...
          <div className="noesis-ledger-row">
            ...
            <span>
              Fee split<small>19% liquidity, 80% endowment — a contract constant</small>
            </span>
            <span className="v">19% or 80%</span>
          </div>
          <div className="noesis-ledger-row">
        ...
        <div className={`noesis-bind ${styles.heroBind}`}>
          ...
          <div className="cell vault">
            alignment vault<b>19% / 80%</b>
          </div>
        </div>
        <p className={styles.heroFoot}>
          ▪ the ratio is contract-enforced · the payee is a listing decision you can watch
        </p>
      </aside>
    </div>
  )
